  ...
  const employeeSummariesData = useMemo(() => {
    const employeeGroups = filteredSummaries.reduce(
      (acc, summary) => {
        ...
        const costWithoutLoa = hourlyCost - entryLoaCost;

        group.totalLoaAmount = (group.totalLoaAmount || 0) + entryLoaCost;
        group.totalCostWithoutLoa += costWithoutLoa;
        if (summary.loaCount) {
                        ...
                        <div key={employee.employeeName}>
                          ...
                          <div className="bg-gray-800/50 border border-gray-700/50 rounded-lg p-4 space-y-3">
                            <div className="flex items-center justify-between">
                              ...
                              <div
                                className="grid gap-2 text-center overflow-x-auto"
                                style={{
                                  gridTemplateColumns:
                                    "minmax(65px, 1fr) minmax(85px, 1fr) minmax(90px, 1fr) minmax(80px, 1fr) minmax(90px, 1fr) minmax(90px, 1fr) minmax(75px, 1fr) minmax(85px, 1fr) minmax(70px, 1fr)",
                                }}
                              >
                                <div>
