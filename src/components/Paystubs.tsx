                ...
                <div className="flex items-center justify-between">
                  <div>
                    <CardTitle className="text-xl text-gray-100 flex items-center gap-2">
                      ...
                      <button
                        onClick={() => {
                          console.log('Email button clicked for:', paystub.employeeName);
                          generatePaystubEmail(paystub);
                        }}
                        className="hover:text-orange-300 hover:underline transition-colors duration-200 text-left flex items-center gap-2"
                        title="Click to generate email with paystub (opens default email client)"
                      >
                        {paystub.employeeName}
                        <Mail className="h-4 w-4 text-gray-400 hover:text-orange-300 transition-colors" />
                      </button>
                    </CardTitle>
