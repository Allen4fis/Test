...
export const Paystubs = () => {
  ...
  // State for email preview dialog
...
Generated by 4Front Trackity-doo`;
    ...
    try {
      // Method 1: Create a mailto link with recipient email and click it
      ...
      <div className="space-y-6">
        ...
        <Dialog open={!!emailPreview} onOpenChange={(open) => {
          ...
          <DialogContent className="max-w-2xl bg-gray-800 border-gray-700">
            <DialogHeader>
              <DialogTitle className="text-gray-100">Email Ready to Send</DialogTitle>
              <DialogDescription className="text-gray-400">
                Copy the email content below and paste it into Outlook to send to {emailPreview?.recipientName}
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="mt-1 p-2 bg-gray-700 rounded border border-gray-600 text-gray-100">
              ...
              <div>
                ...
                <div className="mt-1 p-3 bg-gray-700 rounded border border-gray-600 text-gray-100 whitespace-pre-wrap text-sm max-h-64 overflow-y-auto">
                  {emailPreview?.body}
                </div>
              </div>
            </div>
            ...
            <DialogFooter className="flex gap-2 justify-end">
              ...
              <Button
                onClick={() => {
                  const fullEmail = `To: ${emailPreview?.recipientEmail}\nSubject: ${emailPreview?.subject}\n\n${emailPreview?.body}`;
